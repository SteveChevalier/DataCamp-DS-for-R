...
```{r}
	...
	# Calculate 6 + 12
	6 + 12
	# Icon exercise interactive Arithmetic with R
	# An addition
	5 + 5 
	# A subtraction
	5 - 5 
...
# Check class of class my_character
class(my_character)
print(my_character)
...
print(poker_winning_days <- poker_vector[selection_vector])
```
...
```{r}
# Lists --------------
# Vector = on dim arr, Matrices = 2 dim arr (V and M only have one data type) Data Frames = objects, 2d arr
